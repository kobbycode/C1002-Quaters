    ...
    <div className="pt-24 min-h-screen bg-background-light">
      ...
      <section className="relative h-[40vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <h1 className="text-3xl md:text-5xl font-black font-serif text-white mb-6">Unmatched *Comfort*</h1>
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-10 py-20">
        ...
        <section className="mt-32 p-10 md:p-20 bg-charcoal rounded-[3rem] relative overflow-hidden text-center">
          ...
          <div className="relative z-10">
            <h3 className="text-2xl md:text-4xl font-black font-serif text-white mb-8 italic">Ready for the *{config.brand.name}* Experience?</h3>
