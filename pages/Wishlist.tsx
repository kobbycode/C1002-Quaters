              ...
              <div key={room.id} className="group bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-700 border border-gray-50 flex flex-col animate-fade-in">
                ...
                <div className="p-8 flex-1 flex flex-col">
                  ...
                  <div className="mt-auto flex items-center justify-between">
                    ...
                    <Link to={`/rooms/${room.id}`} className="bg-primary hover:bg-blue-600 text-white font-black py-4 px-8 rounded-xl transition-all shadow-lg hover:shadow-primary/30 uppercase tracking-[0.2em] text-[10px]">
                      View Details
                    </Link>
                  </div>
                </div>
