                ...
                <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm">
                    ...
                    <div className="space-y-6 bg-gray-50 rounded-[2rem] p-8 border border-gray-100 mb-10">
                        ...
                        <button
                            ...
                            className="bg-charcoal text-white font-black px-8 py-4 rounded-xl hover:bg-gold transition-all shadow-xl shadow-charcoal/10 uppercase tracking-widest text-xs cursor-pointer"
                        >
                            Infuse Knowledge
                        </button>
                    </div>
                            ...
                            knowledgeBase.map((fact, i) => (
                                <div key={i} className="group bg-white p-6 rounded-2xl border border-gray-100 hover:border-gold/30 hover:shadow-lg transition-all relative">
                                    ...
                                    <button
                                        ...
                                        className="absolute top-6 right-6 p-2 bg-red-50 text-red-500 rounded-lg opacity-0 group-hover:opacity-100 hover:bg-red-500 hover:text-white transition-all shadow-sm cursor-pointer"
                                    >
